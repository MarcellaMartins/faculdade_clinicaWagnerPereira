...
public class Cadastro_Usuarios extends javax.swing.JFrame {
    ...
    public boolean ValidarDados() {
        ...
        if (func.Formacao == null || (func.Formacao.isEmpty() || func.Formacao.isBlank())) {
            JOptionPane.showMessageDialog(jButton1, "Campo 'Matrícula' não pode ficar em branco!");
            return false;
        }

        if (func.Matricula == null || (func.Matricula.isEmpty() || func.Matricula.isBlank())) {
            JOptionPane.showMessageDialog(jButton1, "Campo 'Matrícula' não pode ficar em branco!");
            return false;
        }

        if (func.Senha == null || (func.Senha.isEmpty() || func.Senha.isBlank())) {
            JOptionPane.showMessageDialog(jButton1, "Campo 'Senhas' não pode ficar em branco!");
            return false;
        }

        if (confirmarSenha == null || (confirmarSenha.isEmpty() || confirmarSenha.isBlank())) {
